    ...
    <tr>
      ...
      <c:forEach items="${tariffzoneList}" var="tariffZone">
          ...
          <tr id="${tariffZone.id}">
            ...
            <td>
              <div>
              <label for="${tariffZone.id}">
                <c:choose>
                  <c:when test="${tariffZone.dollar == true}">
                    <input id="${tariffZone.id}" name="softblock" class="softBlock" type="checkbox" checked data-size="mini">
                  </c:when>
                  <c:otherwise>
                    <input id="${tariffZone.id}" name="softblock" class="softBlock" type="checkbox" data-size="mini">
                  </c:otherwise>
                </c:choose>
              </label>
              </div>
