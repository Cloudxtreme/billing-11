    ...
    <form:form class="form-horizontal" method="POST" commandName="transactionForm" action="${pageContext.request.contextPath}/transaction/modifyForm">
        <fieldset>
            ...
            <div class="form-group" id="ipNetDiv">
                <label for="accountId" class="col-lg-3 control-label">Account</label>
                <div class="col-lg-9">
            ...
            <div class="form-group">
                <label for="direction" class="col-lg-3 control-label">Transaction Direction</label>
                <div class="col-lg-9">
            ...
            <div class="form-group">
                <label for="source" class="col-lg-3 control-label">Transaction Source</label>
                <div class="col-lg-9">
