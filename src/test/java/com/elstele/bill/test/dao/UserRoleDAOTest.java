...
public class UserRoleDAOTest {
    ...
    @Before
    public void setUp() {
        sessionFactory.getCurrentSession().createSQLQuery("DELETE FROM ROLE_ACTIVITY").executeUpdate();
        sessionFactory.getCurrentSession().createQuery("DELETE FROM Activity").executeUpdate();
        sessionFactory.getCurrentSession().createSQLQuery("DELETE FROM user_userrole").executeUpdate();
        sessionFactory.getCurrentSession().createSQLQuery("DELETE FROM userrole").executeUpdate();
