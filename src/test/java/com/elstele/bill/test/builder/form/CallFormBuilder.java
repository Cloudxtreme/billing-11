...
public class CallFormBuilder {
    ...
    public CallFormBuilder randomNumberA(){
        callForm.setNumberA(RandomStringUtils.randomAlphanumeric(7));
        return this;
    }

    public CallFormBuilder randomNumberB(){
        callForm.setNumberB(RandomStringUtils.randomAlphanumeric(10));
        return this;
    }
